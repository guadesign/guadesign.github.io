...
export const skills = {
  es: ['Identidad visual', 'Motion graphics', 'Diseno editorial', 'Redes sociales', 'After Effects', 'Photoshop', 'Illustrator', 'Figma', 'Premiere Pro', 'InDesign'],
...
export const proyectos = [
  {
    ...
    desc: {
      es: 'Pack de graficas animadas para broadcasting y redes sociales.',
  ...
  },
  {
    ...
    tag: { es: 'Diseno Editorial', en: 'Editorial Design' },
    desc: {
      es: 'Exploracion tipografica con sistema de grilla suizo.',
  ...
  },
  {
    ...
    desc: {
      es: 'Interfaz ficticia de usuario para una mision espacial.',
